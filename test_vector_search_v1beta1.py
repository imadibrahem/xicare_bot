#!/usr/bin/env python3
"""
Alternative Vector Search test using v1beta1 API
Run: python3 test_vector_search_v1beta1.py
"""
...
try:
    ...
    print(f"[2] Testing Vector Search query (v1beta1)...")
