					...
					<div class="mx-4 flex h-full flex-col items-center justify-center gap-10 py-4 md:mx-10">
						<div class="max-w-2xl text-center">
							...
							<p class="[&:not(:first-child)]:mt-6">
								...
								augue bibendum, ac mattis sem lobortis. Duis at vestibulum urna, vitae accumsan
								erat. Sed velit ipsum, tincidunt et ex eu, pulvinar sagittis dolor. Vestibulum in
								dictum quam. Donec vestibulum id mi ac congue. Duis ut tristique magna, vitae
								dapibus dolor. Pellentesque eget risus nec est ultrices euismod.
							</p>
						</div>
